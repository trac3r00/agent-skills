...
FAMILIES = {
    ...
    "backend": ["env-gate", "diff-review", "portfolio-audit", "doc-reader",
                "seo-audit", "resume-audit", "api-tester", "log-analyzer", "json-diff", "repo-audit", "changelog-gen", "code-review", "sec-headers", "net-probe", "sys-health",
                "graph-tools", "ext-scaffold", "cron-audit", "gh-fix-ci", "gh-address-comments"],
    "process": ["systematic-debugging", "test-driven-development",
                ...
                "grilling", "domain-modeling", "linus-level", "astra-init"],
